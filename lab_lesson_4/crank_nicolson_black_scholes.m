function crank_nicolson_black_scholes(NS, Nt)
    % CRANK_NICOLSON_BLACK_SCHOLES Solves the Black-Scholes equation using the crank_nicolson method.
    %
    %   crank_ nicolson_black_scholes(NS, Nt) solves the Black-Scholes PDE for a European call option
    ...
    title('crank nicolson Finite Difference Method for Black-Scholes Equation');
    shading interp;
end
